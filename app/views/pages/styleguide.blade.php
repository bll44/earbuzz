...
<div class="panel">
	...
	<!-- Styles  -->
	<dl class="eb-sub-nav sub-nav">
		<dt>Styles:</dt>
		<dd class="active"><a href="?style=all">Show All</a></dd>
		<dd><a href="?style=navigation">Navigation</a></dd>
		<dd><a href="?style=kitchen-sink">Kitchen Sink</a></dd>
	</dl>

	<!-- NAVBAR PARTIAL -->
	@if ( $style === "navigation" || $style === "all")
		<h2>navbar.blade.php</h2>
		<hr>
		@include('layouts/partials/navigation')
	@endif

	<!-- Kitchen Sink -->
	@if ( $style === "kitchen-sink" || $style === "all" )
		<div class="row">
			...
			<ul class="small-block-grid-2 large-block-grid-4">
			  <li><img class="th hoverZoomLink" src="../assets/img/examples/comet-th.jpg"></li>
			...
			<p><a href="#" data-dropdown="drop" class="tiny button dropdown" aria-expanded="false">Tiny Dropdown Button</a><br>
			<a href="#" data-dropdown="drop" class="small secondary radius button dropdown" aria-expanded="false">Small Secondary Radius Dropdown Button</a><br>
			<a href="#" data-dropdown="drop" class="button alert round dropdown" aria-expanded="false">Button Alert Round Dropdown Button</a><br>
			<a href="#" data-dropdown="drop" class="large success button dropdown" aria-expanded="false">Large Success Dropdown Button</a><br>
			<a href="#" data-dropdown="drop" class="large button dropdown expand" aria-expanded="false">Large Expanded Dropdown Button</a></p>
			<hr>
			<h4 id="split-buttons">Split Buttons</h4>
			<p> <a href="#" class="tiny button split">Tiny Split Button <span data-dropdown="drop" aria-expanded="false"></span></a><br>
			 <a href="#" class="small secondary radius button split">Small Secondary Radius Split Button <span data-dropdown="drop" aria-expanded="false"></span></a><br>
			 <a href="#" class="button alert round split">Round Alert Split Button <span data-dropdown="drop" aria-expanded="false"></span></a><br>
			 <a href="#" class="large success button split">Large Success Split Button <span data-dropdown="drop" aria-expanded="false"></span></a></p>
			<hr>
			...
			<div>
			  <div class="clearing-assembled"><div><a href="#" class="clearing-close">×</a><div class="visible-img" style="display: none"><div class="clearing-touch-label"></div><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" alt=""><p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#" class="clearing-main-next"><span></span></a></div><div class="carousel"><ul class="clearing-thumbs" data-clearing="">
			    <li><a class="th hoverZoomLink" href="../assets/img/examples/comet.jpg"><img data-caption="Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum." src="../assets/img/examples/comet-th-sm.jpg"></a></li>

			    <li><a class="th hoverZoomLink" href="../assets/img/examples/earth.jpg"><img src="../assets/img/examples/earth-th-sm.jpg"></a></li>

			    <li><a class="th hoverZoomLink" href="../assets/img/examples/launch.jpg"><img data-caption="Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus." src="../assets/img/examples/launch-th-sm.jpg"></a></li>

			    <li><a class="th hoverZoomLink" href="../assets/img/examples/satelite.jpg"><img src="../assets/img/examples/satelite-th-sm.jpg"></a></li>

			    <li><a class="th hoverZoomLink" href="../assets/img/examples/space.jpg"><img data-caption="Integer posuere erat a ante venenatis dapibus posuere velit aliquet." src="../assets/img/examples/space-th-sm.jpg"></a></li>
			  </ul></div></div></div>
			</div>
			...
			<div class="row">
			  <div class="large-12 columns">
			    <div class="orbit-container"><ul id="featured1" data-orbit="" data-options="timer_speed:5000;" class="orbit-slides-container" style="height: 252px;">
			    ...
			    </ul><a href="#" class="orbit-prev"><span></span></a><a href="#" class="orbit-next"><span></span></a><div class="orbit-timer paused"><span></span><div class="orbit-progress" style="width: 22.5%;"></div></div><div class="orbit-slide-number"><span>3</span> of <span>3</span></div><div class="orbit-bullets-container"><ol class="orbit-bullets"><li data-orbit-slide="0" class=""></li><li data-orbit-slide="1" class=""></li><li data-orbit-slide="2" class="active"></li></ol></div></div>
			  </div>
			</div>
			...
			<div class="range-slider" data-slider="50">
			    <span class="range-slider-handle" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" style="-webkit-transform: translateX(405.5px); transform: translateX(405.5px);"></span>
			...
			<div class="range-slider" data-slider="40" data-options="step: 20;">
			    <span class="range-slider-handle" aria-valuemin="0" aria-valuemax="100" aria-valuenow="40" style="-webkit-transform: translateX(324.2px); transform: translateX(324.2px);"></span>
			...
			<p>The tooltips can be positioned on the <span data-tooltip="" class="has-tip" data-width="210" data-selector="tooltip-i0whrfyb0" aria-describedby="tooltip-i0whrfyb0" title="">"tip-bottom"</span>, which is the default position, <span data-tooltip="" class="has-tip tip-top noradius" data-width="210" data-selector="tooltip-i0whrfyb1" aria-describedby="tooltip-i0whrfyb1" title="">"tip-top" (hehe)</span>, <span data-tooltip="left" class="has-tip tip-left" data-width="90" title="">"tip-left"</span>, or <span data-tooltip="right" class="has-tip tip-right" data-width="120" title="">"tip-right"</span> of the target element by adding the appropriate class to them. You can even add your own custom class to style each tip differently. On a small device, the tooltips are full width and bottom aligned.</p>
